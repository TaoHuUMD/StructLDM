...
from Engine3D.th_utils.distributed.sampler import data_sampler
...
def get_transform(opt, params, method=Image.BICUBIC, normalize=True, dp = False):
    transform_list = []
